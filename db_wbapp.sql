...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2659598694ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="712">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_wbapp&table=tbl_appointment">`db_wbapp`.`tbl_appointment`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_wbapp&table=tbl_users">`db_wbapp`.`tbl_users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=company_bsit2-a&table=employer">`company_bsit2-a`.`employer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=company_bsit2-a&table=employee">`company_bsit2-a`.`employee`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=humbles_reservation&table=reservation">`humbles_reservation`.`reservation`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=humbles_reservation&table=reservation_history">`humbles_reservation`.`reservation_history`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=humbles_reservation&table=users">`humbles_reservation`.`users`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="5a5a42744633786060742b415e287b43">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="712"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
